...
public class CargarPropiedad extends JPanel {
    ...
    private JLabel nombreLabel8 = new JLabel("caca8");
    ...
    private JTextField nombreTextField8 = new JTextField();
    ...
    public CargarPropiedad() {
        ...
        nombreTextField8.setPreferredSize(new Dimension(Constants.TEXTFIELD_WIDTH, Constants.TEXTFIELD_HEIGHT));
        nombreTextField8.setMinimumSize(new Dimension(Constants.TEXTFIELD_WIDTH, Constants.TEXTFIELD_HEIGHT));
        nombreTextField8.setMaximumSize(new Dimension(Constants.TEXTFIELD_WIDTH, Constants.TEXTFIELD_HEIGHT));
