package com.ingsof2.panels.cargarComprador;
...
public class CargarComprador extends JPanel {
    ...
    public Comprador saveFields() {
        if (validateFields()) {
            return new Comprador(nombreTextField.getText(),
