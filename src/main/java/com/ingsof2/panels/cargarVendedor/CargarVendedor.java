...
public class CargarVendedor extends JPanel {
    ...
    public CargarVendedor(Vendedor vendedor) {
    ...
    private void setData(Vendedor vendedor) {
        nombreTextField.setText(vendedor.getNombre());
        apellidoTextField.setText(vendedor.getApellido());
        dniTextField.setText(vendedor.getDni());
        dniTextField.setEnabled(false);
        sexoComboBox.setSelectedItem(vendedor.getSexo());
        sexoComboBox.setEnabled(false);
        direccionTextField.setText(vendedor.getDireccion());
        fechaDeNacimientoTextField.setText(vendedor.getFechaNac());
        telefonoTextField.setText(vendedor.getTelefono());
        emailTextField.setText(vendedor.getEmail());
    }
    ...
    public Vendedor saveFields() {
        if (validateFields()) {
            return new Vendedor(nombreTextField.getText(),
