...
public class Vendedor extends Persona { // Este es el que vende el inmueble
    ...
    public static Object[][] getDataVector(List<Vendedor> vendedores) {
        Object[][] objects = new Object[vendedores.size()][0];

        for (int i = 0; i < vendedores.size(); i++) {
            objects[i] = vendedores.get(i).toObject();
        }
        return objects;
    }
